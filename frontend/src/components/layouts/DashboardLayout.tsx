      ...
      <header className="lg:hidden fixed top-0 left-0 right-0 z-50 glass border-b border-primary-400/10">
        <div className="flex items-center justify-between px-4 h-16">
          <Link to="/" className="flex items-center space-x-2">
            ...
            <span className="text-lg font-luxury font-semibold tracking-wider gold-text">SAFIRALUX</span>
          </Link>
          <button
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="hidden lg:flex items-center px-6 h-20 border-b border-primary-400/10">
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-luxury font-semibold tracking-wider gold-text">SAFIRALUX</span>
            </Link>
          </div>
